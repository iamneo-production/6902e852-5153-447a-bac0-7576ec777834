...
function Update() {
    ...
    return ( <
        ...
        br > < /br> <
        Form.Control name = "serviceCenterName"
        value = { serviceCenterName }
        onChange = {
            (e) => changeState(e.target.value, e.target.name) }
        type = "text"
        ...
        br > < /br> <
        Form.Control name = "serviceCenterEmail"
        type = "text"
        ...
        br > < /br> <
        Form.Control name = "serviceCenterPhone"
        type = "text"
        ...
        br > < /br> <
        Form.Control name = "serviceCenterAddress"
        type = "text"
        ...
        br > < /br> <
        Form.Control name = "serviceCenterImage"
        type = "text"
